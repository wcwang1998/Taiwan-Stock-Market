...
if update:
    ...
    with st.spinner('Updating Data...'):
        ...
        def institutional_investor():
            ...
            inst_investors['上市自營商(合計)'] = inst_investors['上市自營商(自行買賣)'] + inst_investors[
                '上市自營商(避險)']
            inst_investors['三大法人(合計)'] = inst_investors['上市自營商(合計)'] + inst_investors['上市投信'] + \
                                               inst_investors['上市外資及陸資(不含外資自營商)']
